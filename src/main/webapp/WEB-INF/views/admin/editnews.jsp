...
<%@ page contentType="text/html; charset=UTF-8" %>
       ...
       <form:form method="POST" action="${pageContext.request.contextPath }/admin/${newsEntity.id }/editnews" modelAttribute="newsEntity">
        <div id="frm">
             <h4 style="text-align:center">Редагувати новину:</h4>
